...
#PostSim=$(ls $out/$model/$runID/output_$model/pps_Nov_post_sims/)

#for i in $PostSim
#do 

#cp PPS_MCMC.sh $runID"_"$model/$i.sh 

#sed -i -e 's/apple/'$num_states'/g'  $runID"_"$model/$i.sh
#sed -i -e 's/orange/'$runID'/g'  $runID"_"$model/$i.sh
#sed -i -e 's/banana/'$data'/g' $runID"_"$model/$i.sh
#sed -i -e 's/melon/'$out'/g'  $runID"_"$model/$i.sh
#sed -i -e 's/pear/'$model'/g'  $runID"_"$model/$i.sh
#sed -i -e 's/grape/'$i'/g'  $runID"_"$model/$i.sh


#sbatch $runID"_"$model/$i.sh
#done
